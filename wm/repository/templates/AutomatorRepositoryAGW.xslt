    ...
    <Projects>
      ...
      <Project  type="Repository" overwrite="true" ignoreMissingDependencies="true">
        ...
        <DeploymentSet autoResolve="ignore">
          ...
          <xsl:attribute name="description">
            <xsl:value-of select="concat($projectName,' APIGateway DeploymentSet')"/>
          </xsl:attribute>
          ...
          <Composite type="APIGateway" displayName="Assets for API Gateway">
		...
		<DeploymentMap>			
	         <xsl:attribute name="description">
	            <xsl:value-of select="concat($projectName,' APIGateway Deployment Map')"/>
	         </xsl:attribute>
		...
		<DeploymentCandidate>
	         ...
	         <xsl:attribute name="description">
	            <xsl:value-of select="concat($projectName,' APIGateway Deployment Candidate')"/>
	         </xsl:attribute>
